...
class WalkerBase(XmlBasedRobot):
    ...
    def robot_specific_reset(self, bullet_client):
        ...
        for j in self.ordered_joints:
            j.reset_current_position(self.np_random.uniform(low=-0.0, high=0.0), 0)  #was low -0.1, high 0.1  MADE so for multiagent for DETERMINISTIC behaviour
    ...
    def calc_state(self):
        ...
        self.walk_target_dist = 1e3 - self.body_xyz[2]  + abs(self.body_xyz[0]) + abs(self.body_xyz[1]) ## just maximize z  and what it to be in [0,0, max]
        self.walk_target_dist = np.linalg.norm(
    ...
    def calc_potential(self):
        ...
        try:
            ...
            if debugmode:
                ...
                print(self.scene.timestep)
            return abs( - self.walk_target_dist / self.scene.dt)
        except AttributeError:
